...
public final class ChatItemRightBinding implements ViewBinding {
  ...
  private ChatItemRightBinding(@NonNull RelativeLayout rootView, @NonNull TextView fileImage,
  ...
  public static ChatItemRightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChatItemRightBinding((RelativeLayout) rootView, fileImage, fileMessageLayout,
