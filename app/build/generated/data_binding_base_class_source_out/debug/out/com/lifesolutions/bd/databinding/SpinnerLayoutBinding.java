...
public final class SpinnerLayoutBinding implements ViewBinding {
  ...
  private SpinnerLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView textSpinner) {
  ...
  public static SpinnerLayoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.text_spinner;
      TextView textSpinner = ViewBindings.findChildViewById(rootView, id);
      if (textSpinner == null) {
        break missingId;
      }

      return new SpinnerLayoutBinding((LinearLayout) rootView, textSpinner);
    }
