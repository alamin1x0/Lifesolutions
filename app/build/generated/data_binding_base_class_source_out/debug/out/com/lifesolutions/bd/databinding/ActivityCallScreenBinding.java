...
public final class ActivityCallScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final RelativeLayout rootLayoutCallScreen;
  ...
  private ActivityCallScreenBinding(@NonNull RelativeLayout rootView, @NonNull AdView adView,
      ...
      @NonNull RelativeLayout rootLayoutCallScreen, @NonNull TextView statusCallScreen,
    ...
    this.rootLayoutCallScreen = rootLayoutCallScreen;
  ...
  public static ActivityCallScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RelativeLayout rootLayoutCallScreen = (RelativeLayout) rootView;
      ...
      return new ActivityCallScreenBinding((RelativeLayout) rootView, adView, backButtonCallScreen,
          ...
          muteCallScreen, nameCallScreen, profileImageCallScreen, rootLayoutCallScreen,
