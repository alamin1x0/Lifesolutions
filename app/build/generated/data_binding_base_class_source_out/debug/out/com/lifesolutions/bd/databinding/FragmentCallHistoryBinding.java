...
public final class FragmentCallHistoryBinding implements ViewBinding {
  ...
  private FragmentCallHistoryBinding(@NonNull FrameLayout rootView,
  ...
  public static FragmentCallHistoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_call_history_, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentCallHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCallHistoryBinding((FrameLayout) rootView, btnDeleteCallLog,
