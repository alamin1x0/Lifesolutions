...
public final class EditPostDailogBinding implements ViewBinding {
  @NonNull
  private final LinearLayout rootView;

  @NonNull
  public final Button btnUploadCancel;

  @NonNull
  public final Button btnUploadConfirm;
  ...
  private EditPostDailogBinding(@NonNull LinearLayout rootView, @NonNull Button btnUploadCancel,
      @NonNull Button btnUploadConfirm, @NonNull EditText etPostDesc,
      @NonNull ImageView ivPickedImage, @NonNull ImageView ivPickedImage2,
      @NonNull ImageView ivPickedImage22, @NonNull ImageView ivPickedImage3,
      @NonNull ImageView ivPickedImage32, @NonNull ImageView ivPickedImage33,
      @NonNull ImageView ivPickedImage41, @NonNull ImageView ivPickedImage42,
      @NonNull ImageView ivPickedImage43, @NonNull ImageView ivPickedImage44,
      @NonNull LinearLayout singleview, @NonNull LinearLayout singleview2,
      @NonNull LinearLayout singleview3, @NonNull LinearLayout singleview4,
  ...
  @NonNull
  public static EditPostDailogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EditPostDailogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.edit_post_dailog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EditPostDailogBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btn_upload_cancel;
      Button btnUploadCancel = ViewBindings.findChildViewById(rootView, id);
      if (btnUploadCancel == null) {
        break missingId;
      }

      id = R.id.btn_upload_confirm;
      Button btnUploadConfirm = ViewBindings.findChildViewById(rootView, id);
      ...
      return new EditPostDailogBinding((LinearLayout) rootView, btnUploadCancel, btnUploadConfirm,
