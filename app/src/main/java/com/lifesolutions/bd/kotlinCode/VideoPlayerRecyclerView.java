...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    private ArrayList<VideoPost> mediaObjects2 = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if(!isEndOfList){
            ...
            targetPosition = mediaObjects2.size() - 1;
        }
        ...
        String mediaUrl2 = mediaObjects2.get(targetPosition).getVideoUrl();
        if (mediaUrl2 != null) {
            MediaSource videoSource = new ExtractorMediaSource.Factory(dataSourceFactory)
                    .createMediaSource(Uri.parse(mediaUrl2));
    ...
    public void setMediaObjects(ArrayList<VideoPost> mediaObjects){
