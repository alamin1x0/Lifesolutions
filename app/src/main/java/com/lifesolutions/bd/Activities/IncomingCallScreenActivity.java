   ...
   /// private AdView mAdView;
    ...
    protected void onServiceConnected() {
        ...
        if (call != null) {
            ...
            getCallerInfo(tvName, profileImage, mainCallBgProfile, call.getRemoteUserId());
    ...
    private void answerClicked() {
        ...
        if (call != null) {
            mAudioPlayer.stopRingtone();
            call.answer();
            createCallLogConversation("voice", "incoming");
    ...
    private class SinchCallListener implements CallListener {
        ...
        public void onCallEnded(Call call) {
            ...
            if (cause.toString().equals("CANCELED")) {
                ...
                createCallLogConversation("voice", "missed");
            }
    ...
    private void sendMissedCallNotification() {
        Call call = getSinchServiceInterface().getCall(mCallId);
        CommonNotification notification = new CommonNotification(this, "MISSED_CALL", "Audio", call.getRemoteUserId(), fullNameOfCaller);
