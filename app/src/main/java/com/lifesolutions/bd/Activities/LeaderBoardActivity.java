...
public class LeaderBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Display display = LeaderBoardActivity.this.getWindowManager().getDefaultDisplay();
        ...
        mLayoutManager = new GridLayoutManager(LeaderBoardActivity.this,columns);
        ...
        if(mAuth != null){
            ...
            Intent intent = new Intent(LeaderBoardActivity.this, LoginKtActivity.class);
        ...
        if (InternetCheck.checkConnection(this)) {
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (users.size() == 0){
                        Toast.makeText(LeaderBoardActivity.this, "Empty", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        mAdapter = new LeaderBoardListAdapter(LeaderBoardActivity.this,sortedUsers);
