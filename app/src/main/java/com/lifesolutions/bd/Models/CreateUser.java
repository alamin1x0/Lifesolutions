...
public class CreateUser {
    private String email,phone,password,referCode,role,imageThumbnail,imageMedium,imageHD,uID,registrationType,deviceId,ipAddress;
