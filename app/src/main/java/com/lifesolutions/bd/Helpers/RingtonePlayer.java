...
public class RingtonePlayer {
    ...
    static final String LOG_TAG = RingtonePlayer.class.getSimpleName();
        ...
        switch (audioManager.getRingerMode()) {
            case AudioManager.RINGER_MODE_NORMAL:
                ...
                try {
                   ...
                   // mPlayer.setDataSource(mContext, Uri.parse("android.resource://" + mContext.getPackageName() + "/" + R.raw.ringtone_by_sojol));
                    mPlayer.prepare();
                } catch (IOException e) {
